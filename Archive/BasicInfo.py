...
def EnterBasicInfo():
            ...
            <div class="container">
                    ...
                    <div class="collapse navbar-collapse">
                            <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="projdescip.html">Project Description</a></li>
                                    <li  class="active"><a href="BasicInfo.py">Demo</a></li>
                            </ul>               
                    </div>
            </div>
	</div>    
    <center>Please Enter the column below</center>
    <form class="form-horizontal" method = "post" action = "crawl8.py" >
    ...
    <tr><td>
    <input type="submit" id="GetInfo" name="GetInfo" value="Submit">
    </tr></td>
    </table>
    </form>
