...
def printOut(getRecommend):
    ...
    print """
		...
		<body>
            ...
            <script type="text/javascript">
	            ...
	            if (location.length > 0) {
                    for (var i = 0; i < location.length; i++) {
                        locationhref = link + location[i];
                        document.getElementById("arrayString").innerHTML=locationhref;
                    }
	            }*/
	        ...
	        if (age.length > 0) {
                    //jQuery.each(age, function(i, val) {
                    
                    for (var i = 0; i < age.length; i++) {
                        //temp = temp + href + val + "<br />";
                        temp = href + age[i];
                        //console.log(temp);
                        //$('#test').append(temp);
                        $('#arrayString').append('<a class = "btn btn-default" id="linkTo" href = "">Link</a>');
				...
				//console.log(temp);
                    		...
                    		//});
                    		//document.getElementById(linkstr).location = temp;                        
